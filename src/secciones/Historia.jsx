      ...
      <div className="container">
        ...
        <div className="grid-cards">
          <article className="card">
            ...
            <p>Sesiones personalizadas para personas en México y atención a distancia.</p>
          </article>
          <article className="card">
            <h3>Confidencialidad total</h3>
            <p>Tu proceso es privado. Te acompaño con respeto y empatía.</p>
          </article>
          <article className="card">
            <h3>Resultados reales</h3>
            <p>Rituales enfocados en desbloqueos y guía espiritual con seguimiento.</p>
          </article>
        </div>
      </div>
    </section>
